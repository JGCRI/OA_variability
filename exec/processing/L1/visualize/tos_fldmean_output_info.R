...
script_name <- "tos_fldmean_output_info.R"
...
# 1. Import Data
# ------------------------------------------------------------------------------
files_found <- read.csv(paste0(DATA_DIR, "cmip5_identified_fldmean_monthly_tos.csv"))
output      <- read.csv(paste0(DATA_DIR, "fldmean_monthly_tos.csv"))
depth       <- read.csv(paste0(DATA_DIR, "checked_for_depth_tos.csv"))
