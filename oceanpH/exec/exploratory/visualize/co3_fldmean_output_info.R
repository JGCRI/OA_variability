...
# the output from the fldmean Co3 analysis. It is set up to return a list about
...
script_name <- "co3_fldmean_output_info.R"
...
# 1. Import Data
# ------------------------------------------------------------------------------
files_found <- read.csv(paste0(DATA_DIR, "cmip5_identified_fldmean_monthly_co3.csv"))
output      <- read.csv(paste0(DATA_DIR, "fldmean_monthly_co3.csv"))
depth       <- read.csv(paste0(DATA_DIR, "checked_for_depth_co3.csv"))
